...
export const en = {
  ...
  'order.payBill': 'Pay bill',

  // ── Checkout / pay-at-table ───────────────────────────────────────────────
  'checkout.title': 'Pay your bill',
  'checkout.subtitle': 'Settle right from your phone',
  'checkout.subtotal': 'Subtotal',
  'checkout.serviceCharge': 'Service charge',
  'checkout.gst': 'GST',
  'checkout.cgst': 'CGST',
  'checkout.sgst': 'SGST',
  'checkout.tip': 'Tip',
  'checkout.total': 'Total to pay',
  'checkout.splitLabel': 'Split the bill',
  'checkout.splitNone': "I'll pay it all",
  'checkout.splitEven': 'Split evenly',
  'checkout.splitWays': 'ways',
  'checkout.perPerson': 'per person',
  'checkout.tipLabel': 'Add a tip',
  'checkout.tipNone': 'No tip',
  'checkout.payNow': 'Pay',
  'checkout.processing': 'Processing…',
  'checkout.paid': 'Paid — thank you!',
  'checkout.failed': 'Payment failed. Please try again.',
  'checkout.dismissed': 'Payment cancelled',
  'checkout.demoNote': 'Demo mode — no real charge is made',
  'checkout.secured': 'Secured payment',
  'checkout.upsellTitle': 'Add something sweet?',
  'checkout.add': 'Add',
